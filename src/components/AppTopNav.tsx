...
export default function AppTopNav({
  ...
  return (
    <nav className="app-top-nav sticky top-[68px] sm:top-[73px] z-20 border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-xl px-3 md:px-12">
      <div className="mx-auto flex max-w-7xl items-center gap-1.5 sm:gap-2 overflow-x-auto py-2 scrollbar-thin">
        {showGuidedMode && (
          <button
            ...
            className="guided-mode-button flex shrink-0 items-center gap-2 rounded-xl border border-amber-500/45 bg-amber-500 px-3.5 py-2 text-[11px] sm:text-xs font-black text-slate-950 shadow-lg shadow-amber-900/20 transition-all hover:bg-amber-400 cursor-pointer"
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <button
              ...
              className={`nav-section-button flex shrink-0 items-center gap-1.5 sm:gap-2 rounded-xl border px-3 sm:px-3.5 py-2 text-[11px] sm:text-xs font-black transition-all cursor-pointer ${
                isActive
