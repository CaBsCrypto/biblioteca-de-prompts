...
7. Abre el perfil de otro creador, envia una solicitud de conexion y prueba un mensaje cuando la acepten.
...
- [ ] 2 testers envian al menos un mensaje privado entre conexiones.
